...
const Login = () => {
  return (
    <div className="flex bg-teal-500 ">
      <section class="  dark:bg-gray-900 w-6/12 m-auto">
        <div class="flex flex-col items-center justify-center  px-10 py-9 mx-auto md:h-screen lg:py-0">
            ...
            <div class="p-6 space-y-4 ">
              ...
              <form class="space-y-4 md:space-y-6 " action="#">
                <div>
                  <label
                    for="email"
                    class="block mb-2 text-sm font-medium text-green-400  "
                  >
                    Email
                  </label>
                  <input
                ...
                <button
                  type="submit"
                  class="w-full text-white bg-cyan-500 hover:bg-cyan-600 focus:ring-4 focus:outline-none
